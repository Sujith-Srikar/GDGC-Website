...
function Footer() {
  return (
    <>
      <footer className="relative min-h-screen w-full bg-gray-100 ">
        {/* Main Content Wrapper */}
        <div className="flex flex-col items-center justify-center space-y-8 md:flex-row md:space-y-0 md:space-x-8 md:h-[85vh] px-[5vw]">
          {/* Image Section */}
          <div className="flex justify-center items-center h-auto w-full sm:w-[70vw] md:w-[40vw]">
            <img
          ...
          {/* Socials Section */}
          <div className="socials flex flex-col md:items-start items-center w-full md:w-[40vw]">
        ...
        {/* Copyright Section */}
        <div className="border-t border-black w-full pt-4 px-[5vw] mt-8 md:mt-12">
