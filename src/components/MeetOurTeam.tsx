...
const MeetOurTeam = () => {
  ...
  return (
    <div ref={outerRef} className="outer md:relative rounded-3xl w-full m-auto h-[calc(100vh-72px)] bg-[#D8E2F9] px-6 py-12 flex flex-col gap-4 md:gap-0 md:flex-row overflow-auto md:overflow-hidden">
