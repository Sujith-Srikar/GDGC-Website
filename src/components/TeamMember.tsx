...
const TeamMember = ({MemberName, Role, Image, GithubLink, LinkedinLink} : {MemberName: string, Role: string, Image: any, GithubLink: string, LinkedinLink: string}) => {
  return (
    <div className="team-member max-h-[250px] min-h-[250px] h-[250px] bg-white rounded-3xl border-[1px] border-black border-solid p-6 flex flex-row justify-between">
      <div className="info w-[45%] aspect-square flex flex-col justify-between">
        <div>
