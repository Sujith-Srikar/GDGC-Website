  ...
  return (
    <div className="team-member bg-white md:h-[300px] lg:h-[350px] xl:h-[400px] 2xl:h-[450px] rounded-3xl border-[1px] border-black border-solid p-6 flex flex-col-reverse md:flex-row items-center justify-between gap-4 lg:gap-8">
      ...
      <div className="info flex flex-col justify-between w-full md:w-[45%] h-auto md:h-[96%] text-center md:text-left">
        {/* Member Name */}
        <div>
          <p className="font-bold text-2xl md:text-3xl lg:text-2xl xl:text-4xl 2xl:text-6xl pb-2">{MemberName}</p>
        ...
        <div className="flex justify-center md:justify-start gap-4 mt-4">
          <a className="cursor-pointer" href={GithubLink} target="_blank">
            <img src={GithubIcon} alt="github" className="w-6 h-6 lg:w-8 lg:h-8 xl:w-10 xl:h-10"/>
          </a>
          <a className="cursor-pointer" href={LinkedinLink} target="_blank">
            <img src={LinkedinIcon} alt="linkedin" className="w-6 h-6 lg:w-8 lg:h-8 xl:w-10 xl:h-10"/>
          </a>
        </div>
      </div>
