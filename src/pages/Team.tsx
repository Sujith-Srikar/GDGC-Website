...
const Team = () => {
  ...
  return (
    <div ref={outerRef} className="relative font-GSD_Regular rounded-3xl w-full m-auto h-[calc(100vh-65px)] bg-[#D8E2F9] px-6 py-12 flex flex-col gap-4 md:gap-0 md:flex-row overflow-auto md:overflow-hidden">
